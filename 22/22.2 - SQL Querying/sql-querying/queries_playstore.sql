...
SELECT AVG(rating) as average_rating, category FROM analytics
GROUP BY category
...
SELECT COUNT(reviews) as total_number_play_store_reviews FROM analytics;

--Find all the categories that have more than 300 apps in them.
SELECT category, COUNT(*) as num_apps FROM analytics
GROUP BY category
HAVING COUNT(*) > 300;
...
SELECT app_name, reviews, min_installs, min_installs/reviews as installs_to_view_ratio FROM analytics
playstore-# ORDER BY min_installs/reviews DESC
playstore-# LIMIT 1;